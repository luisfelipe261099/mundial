    ...
    <main className="flex min-h-dvh items-center justify-center bg-[#05070c] px-5 py-10">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center text-center">
          <Image src="/images/logo.png" alt={business.name} width={56} height={56} className="size-14 rounded-full ring-1 ring-white/10" />
          <h1 className="mt-4 text-xl font-extrabold tracking-tight text-white" style={{ fontFamily: "var(--font-outfit)" }}>
            Criar sua conta
          </h1>
