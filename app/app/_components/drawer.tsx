            ...
            return (
              <li key={item.href}>
                <Link
                  ...
                  className={`relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-[0.95rem] font-medium transition-colors ${
                    active
                ...
                >
                  ...
                  />
                  <Icon className={`size-5 ${active ? "text-[var(--app-brand-2)]" : ""}`} />
                  {item.label}
                </Link>
              </li>
            );
