...
import { getOrdemServico, brl } from "../../_data/mock";
      ...
      <div className="app-card p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="app-display text-[1.05rem] font-bold leading-snug t-ink">
              {os.servico}
            </p>
      ...
      {os.garantia !== "—" && (
        <div className="flex items-center gap-3 rounded-xl bg-emerald-500/10 p-3">
          ...
          <p className="text-sm t-ink">
            Serviço com garantia de{" "}
            <span className="font-semibold">{os.garantia}</span>.
          </p>
        </div>
      )}
