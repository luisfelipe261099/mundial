...
export function NewOrderForm({
    ...
    return (
      <div className="mx-auto max-w-md py-6 text-center">
        ...
        <div className="mt-5 flex justify-center gap-3">
          <Link href="/oficina/ordens" className="adm-btn-primary px-4 py-2.5 text-sm">
            Ver ordens
          </Link>
  ...
  return (
    <div data-tour="adm-neworder" className="mx-auto max-w-3xl space-y-6">
      ...
      <button type="button" disabled={!podeCriar || pending} onClick={criar} className="adm-btn-primary w-full py-3.5 text-sm">
