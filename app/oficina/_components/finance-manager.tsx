      ...
      <div className="adm-card p-5">
        ...
        <div className="grid gap-3 sm:grid-cols-[1fr_10rem_8rem_auto]">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 rounded-lg bg-[var(--ad-brand)] px-4 py-2.5 text-sm font-semibold text-white enabled:hover:bg-[#1b5fe0] disabled:opacity-40"
          >
